...
type AuthMode = 'login' | 'register' | 'admin' | 'forgot-password';
...
export default function SecureAuth({ onAuthenticated }: SecureAuthProps) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (session) {
        // アカウント作成成功、自動的にログイン
        setError('✅ アカウントが正常に作成されました！ダッシュボードに移動します。');
        setTimeout(() => {
          onAuthenticated(session);
        }, 1500);
      } else {
  ...
  const handleXLogin = async () => {
    try {
      setIsLoading(true);
      await authManager.xLogin();
    } catch {
      setError('X認証中にエラーが発生しました。');
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-3 mb-4">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div>
                <input
                  ...
                  className="w-full px-4 py-4 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 text-lg"
              ...
              <button
                ...
                className="w-full bg-black text-white py-4 px-4 rounded-lg font-medium hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 text-lg"
              >
                {isLoading ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200"
